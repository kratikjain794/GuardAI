...
MODEL_PATH = MODEL_DIR / "distress_model.pth"
LAST_MODEL_PATH = MODEL_DIR / "distress_last.pth"
...
def get_distress_label(
    ...
    if emotion in DISTRESS_EMOTIONS:
        return LABEL_TO_INDEX["distress"]

    return LABEL_TO_INDEX["normal"]
...
def main():
    ...
    print("\n================================")
    print("GuardIA Voice Distress Training")
    print("================================")
    ...
    if (
        ...
        print(
            "\nPrevious distress checkpoint found."
        )
        ...
        print(
            "\nStarting new distress training..."
        )
    ...
    if not MODEL_PATH.exists():
        raise FileNotFoundError(
            "Best distress model not found."
        )

    print(
        "\nLoading best distress model..."
    )
